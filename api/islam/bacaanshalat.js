...
// ======================================================
// DATABASE BACAAN SHALAT (LOCAL DATA)
// ======================================================
const databaseShalat = [
    {
        "id": 1,
        "name": "Bacaan Iftitah",
...
// ======================================================
// ENDPOINT UTAMA ROUTER (DIRECT JSON RESPONSE)
// ======================================================
router.get('/', (req, res) => {
    // Langsung mengembalikan seluruh data tanpa proses filtering
    return res.status(200).json({
        status: true,
        creator: 'Arulzxd',
        result: databaseShalat,
        metadata: {
            total_data: databaseShalat.length,
